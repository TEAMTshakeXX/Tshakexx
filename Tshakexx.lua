...
local UserName = (data.username_ or "S_SSS7")
...
local UserName = (b.username_ or "S_SSS7")
...
download_to_file('https://raw.githubusercontent.com/TEAMTshakeXX/Tshakexx/master/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/TEAMTshakeXX/Tshakexx/master/start.lua', 'start.lua') 
dofile('Tshake.lua')  
return false
end
...
🔰┇LiRfeN TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⛓┇ [Source Channel](https://t.me/S_SSS7)

⛓┇ [LiRfeN DeV](https://t.me/T_N_2)

⛓┇ [Source  Files](https://t.me/S_SSS7)
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
🇺🇸┇ [TwS LiRfeN](https://t.me/BM_DXBOT)
]]
send(msg.chat_id_, msg.id_,Text)
end
